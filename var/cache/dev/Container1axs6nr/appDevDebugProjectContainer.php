...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('095mHG2qCD', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U5By3BIxb8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IYdpb+i9id', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yxvWVLTs+F', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\RefugeeBundle/Resources/views'), 'Refugee');
        $instance->addPath(($this->targetDirs[3].'\\src\\RefugeeBundle/Resources/views'), '!Refugee');
        $instance->addPath(($this->targetDirs[3].'\\src\\LostAndFoundBundle/Resources/views'), 'LostAndFound');
        $instance->addPath(($this->targetDirs[3].'\\src\\LostAndFoundBundle/Resources/views'), '!LostAndFound');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'RefugeeBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RefugeeBundle'),
                    'namespace' => 'RefugeeBundle',
                ],
                'LostAndFoundBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LostAndFoundBundle'),
                    'namespace' => 'LostAndFoundBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'RefugeeBundle' => 'RefugeeBundle\\RefugeeBundle',
                'LostAndFoundBundle' => 'LostAndFoundBundle\\LostAndFoundBundle',
