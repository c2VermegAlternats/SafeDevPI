...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\RefugeeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\LostAndFoundBundle\\Entity')]);

$b->addDriver($c, 'RefugeeBundle\\Entity');
$b->addDriver($c, 'LostAndFoundBundle\\Entity');

$a->setEntityNamespaces(['RefugeeBundle' => 'RefugeeBundle\\Entity', 'LostAndFoundBundle' => 'LostAndFoundBundle\\Entity']);
